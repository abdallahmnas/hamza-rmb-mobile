        ...
        child: ListView(
          ...
          children: [
            ...
            _buildAddressCard(
              ...
              address: 'No. 123 Logistics Park, Baiyun District, Guangzhou, Guangdong Province, China',
              recipient: 'Logicore - HZ-20241001',
              phone: '+86 138 0013 8000',
            ),
            const SizedBox(height: 16),
            _buildAddressCard(
              country: 'UK (London)',
              address: 'Unit 4, Heathrow Logistics Hub, London, TW6 2GW, United Kingdom',
              recipient: 'Logicore - HZ-20241001',
        ...
        children: [
          Row(
            children: [
              ...
              Text(country, style: AppTypography.bodyLg.copyWith(fontWeight: FontWeight.w600)),
            ],
          ),
          const SizedBox(height: 16),
  ...
  Widget _buildDetailRow(String label, String value) {
    return Column(
      ...
      children: [
        ...
        Text(value, style: AppTypography.bodyMd.copyWith(fontWeight: FontWeight.w500)),
      ],
    );
  }
}
