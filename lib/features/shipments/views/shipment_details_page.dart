      ...
      child: Column(
        ...
        children: [
          ...
          const _MilestoneEntry(
            ...
            title: 'Flight Departed CAN (In Transit)',
            dateTime: 'Nov 02,',
            description:
                'Air Cargo Flight CZ 3055 departed Baiyun International Airport en route to Lagos hub.',
            isCompleted: true,
          ),
          const _MilestoneEntry(
            ...
            description:
                'Guangzhou Airport Customs formalities and export manifest checks processed successfully.',
            isCompleted: true,
          ),
          const _MilestoneEntry(
            dotColor: Color(0xFFF59E0B),
            iconData: Icons.inventory,
            title: 'Consolidated & Palletized',
            dateTime: 'Nov 01, 15:40',
            description:
                'Assigned to Air Cargo Master ULD Pallet #PL-CAN-9812 and ready for stikerage.',
            isCompleted: true,
          ),
          const _MilestoneEntry(
            dotColor: Color(0xFF0D9488),
            iconData: Icons.warehouse_outlined,
            title: 'Warehouse Intake & QC Inspection',
            dateTime: 'Nov 01,',
            description:
                'Received 3 domestic vendor parcels at Hamza Guanghou Baiyun Logistics Depot.',
            isCompleted: true,
          ),
          const _MilestoneEntry(
            dotColor: Color(0xFF8B5CF6),
            iconData: Icons.notifications_active_outlined,
            title: 'Pre-Alert Registered',
            dateTime: 'Oct 31, 16:00',
            description:
                'Booking and consolidation declared by Sarah Okonjo via Hamza Mobile App.',
            isCompleted: true,
          ),
          const _MilestoneEntry(
            dotColor: Color(0xFF94A3B8),
            iconData: Icons.location_on_outlined,
            title: 'Arrival & Customs Clearance (LOS)',
            dateTime: 'Pending',
            description: 'Lagos international Air Cargo Snag transfer.',
            isCompleted: false,
          ),
          const _MilestoneEntry(
            dotColor: Color(0xFF94A3B8),
            iconData: Icons.check_circle_outline,
            title: 'Depot Collection / Delivery',
            dateTime: 'Pending',
            description: 'Final handover to directed courier dispatch.',
            isCompleted: false,
            isLast: true,
          ),
        ],
